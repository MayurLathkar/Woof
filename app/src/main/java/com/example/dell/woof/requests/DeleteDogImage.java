...
public class DeleteDogImage<T> extends Request<T> {
    ...
    public DeleteDogImage(Context context,String petId, HashMap<String, String> params, Type type, Response
            .Listener<T>
            listener, Response.ErrorListener errorListener){
        super(Method.PUT, AppSpecificConstants.getBaseApi() + AppSpecificConstants
                        .API_deleteDog + petId,
                errorListener);
