...
public class RoundedDrwable extends Drawable {

    public static final String TAG = "RoundedDrwable";
    ...
    public RoundedDrwable(Bitmap bitmap) {
        mBitmap = bitmap;
    ...
    public static RoundedDrwable fromBitmap(Bitmap bitmap) {
        if (bitmap != null) {
            return new RoundedDrwable(bitmap);
        } else {
            return null;
        }
    }
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof RoundedDrwable) {
                // just return if it's already a RoundedDrwable
                return drawable;
            } else if (drawable instanceof LayerDrawable) {
                LayerDrawable ld = (LayerDrawable) drawable;
                int num = ld.getNumberOfLayers();

                // loop through layers to and change to RoundedDrwables if possible
                for (int i = 0; i < num; i++) {
     ...
     * @return the {@link RoundedDrwable} for chaining.
     */
    public RoundedDrwable setCornerRadius(float radius) {
     ...
     * @return the {@link RoundedDrwable} for chaining.
     */
    public RoundedDrwable setCornerRadius(@Corner int corner, float radius) {
     ...
     * @return the {@link RoundedDrwable} for chaining.
     */
    public RoundedDrwable setCornerRadius(float topLeft, float topRight, float bottomRight,
                                           float bottomLeft) {
    ...
    public RoundedDrwable setBorderWidth(float width) {
        mBorderWidth = width;
        mBorderPaint.setStrokeWidth(mBorderWidth);
        return this;
    }
    ...
    public RoundedDrwable setBorderColor(@ColorInt int color) {
    ...
    public RoundedDrwable setBorderColor(ColorStateList colors) {
    ...
    public RoundedDrwable setOval(boolean oval) {
        mOval = oval;
        return this;
    }
    ...
    public RoundedDrwable setScaleType(ScaleType scaleType) {
        if (scaleType == null) {
    ...
    public RoundedDrwable setTileModeX(Shader.TileMode tileModeX) {
    ...
    public RoundedDrwable setTileModeY(Shader.TileMode tileModeY) {
