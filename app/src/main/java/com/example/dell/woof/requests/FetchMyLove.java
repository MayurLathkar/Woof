 ...
 */
public class FetchMyLove<T> extends Request<T> {
    ...
    public FetchMyLove(Context context, HashMap<String, String> params, Type type, Response
            .Listener<T>
    ...
    protected void deliverResponse(T response) {
        ArrayList<MyLove> result = (ArrayList<MyLove>) response;
        if (listener != null)
