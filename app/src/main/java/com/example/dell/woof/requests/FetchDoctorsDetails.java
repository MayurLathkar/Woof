 ...
 */
public class FetchDoctorsDetails<T> extends Request<T> {
    ...
    public FetchDoctorsDetails(Context context,HashMap<String, Object> params, Type type, Response
            .Listener<T>
...
//    }
    ...
    protected void deliverResponse(T response) {
        ArrayList<DoctorsDetails> result = (ArrayList<DoctorsDetails>) response;
        if (listener != null)
