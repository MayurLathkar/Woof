...
import com.example.dell.woof.adapters.CartItemAdapter;
import com.example.dell.woof.interfaces.Saleable;
import com.example.dell.woof.model.Cart;
...
public class ShoppingCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTotalPrice.setText("Rs. " + String.valueOf(cart.getTotalPrice().setScale(2, BigDecimal.ROUND_HALF_UP)));
        ...
        bShop.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShoppingCartActivity.this, CalenderActivity.class);
