 ...
 */
public class SaveDogDetailsRequest<T> extends Request<T> {
    ...
    public SaveDogDetailsRequest(Context context, HashMap<String, Object> params, Type type, Response
            .Listener<T>
    ...
    protected void deliverResponse(T response) {
        DogDetails result = (DogDetails) response;
        if (listener != null)
