...
import com.example.dell.woof.model.Data;
import com.example.dell.woof.services.FlingCardListener;
import com.example.dell.woof.views.SwipeFlingAdapterView;
...
//                @Override
//                public void onClick(View view) {
//                    Log.d("context", parkingList.get(position).getDescription() + "");
//                }
//            });
            viewHolder.cardImage.setBackgroundResource(R.drawable.beer);
            return rowView;
        }
    }
}
