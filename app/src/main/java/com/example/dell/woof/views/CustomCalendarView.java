package com.example.dell.woof.views;
...
import com.example.dell.woof.interfaces.DayDecorator;
...
//    private int currentDayOfMonth;
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        calendarBackgroundColor =  getResources().getColor(R.color.transaparent);
        calendarTitleBackgroundColor =  getResources().getColor(R.color.calender_title_layout_bg_color);
        calendarTitleTextColor =  getResources().getColor(R.color.white);
        weekLayoutBackgroundColor = getResources().getColor(R.color.transaparent);
        dayOfWeekTextColor = getResources().getColor(R.color.white);
        dayOfMonthTextColor =  getResources().getColor(R.color.white);
        disabledDayBackgroundColor =  getResources().getColor(R.color.transaparent);
        disabledDayTextColor =  getResources().getColor(R.color.day_disabled_text_color);
//        selectedDayBackground =  getResources().getColor(R.color.selected_day_background);
        selectedDayTextColor = getResources().getColor(R.color.selected_day_color);
//        currentDayOfMonth =  getResources().getColor(R.color.selected_day_color);
        typedArray.recycle();
    }
    ...
    private void initializeTitleLayout() {
        ...
        dateText = dateText.substring(0, 1) + dateText.subSequence(1, dateText.length()).toString();
...
//            dayOfMonth.setTextColor(currentDayOfMonth);
            dayOfMonth.setBackgroundResource(R.drawable.gradient);
        }
    }
