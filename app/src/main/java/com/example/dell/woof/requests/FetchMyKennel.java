 ...
 */
public class FetchMyKennel<T> extends Request<T> {
    ...
    public FetchMyKennel(Context context, HashMap<String, String> params, Type type, Response
            .Listener<T>
    ...
    protected void deliverResponse(T response) {
        ArrayList<MyKennel> result = (ArrayList<MyKennel>) response;
        if (listener != null)
