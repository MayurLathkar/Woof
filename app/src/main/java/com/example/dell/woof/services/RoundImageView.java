...
public class RoundImageView extends ImageView {
    ...
    private ColorStateList mBorderColor =
            ColorStateList.valueOf(RoundedDrwable.DEFAULT_BORDER_COLOR);
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(RoundedDrwable.DEFAULT_BORDER_COLOR);
        }
        ...
        if (mMutateBackground) {
            ...
            // so it's false by default, what doesn't allow to create the RoundedDrwable. At this point, after load
            // mMutateBackground and updated BackgroundDrawable to RoundedDrwable, the View's background drawable needs to
    ...
    public void setImageDrawable(Drawable drawable) {
        mResource = 0;
        mDrawable = RoundedDrwable.fromDrawable(drawable);
        updateDrawableAttrs();
    ...
    public void setImageBitmap(Bitmap bm) {
        mResource = 0;
        mDrawable = RoundedDrwable.fromBitmap(bm);
        updateDrawableAttrs();
        super.setImageDrawable(mDrawable);
    }
    ...
    private Drawable resolveResource() {
        ...
        return RoundedDrwable.fromDrawable(d);
    }
    ...
    private void updateBackgroundDrawableAttrs(boolean convert) {
        if (mMutateBackground) {
            if (convert) {
                mBackgroundDrawable = RoundedDrwable.fromDrawable(mBackgroundDrawable);
            }
    ...
    private void updateAttrs(Drawable drawable, ScaleType scaleType) {
        ...
        if (drawable instanceof RoundedDrwable) {
            ...
            if (mCornerRadii != null) {
                ((RoundedDrwable) drawable).setCornerRadius(
                        mCornerRadii[Corner.TOP_LEFT],
                        mCornerRadii[Corner.TOP_RIGHT],
                        mCornerRadii[Corner.BOTTOM_RIGHT],
                        mCornerRadii[Corner.BOTTOM_LEFT]);
    ...
    public void setBorderColor(ColorStateList colors) {
        ...
        mBorderColor =
                (colors != null) ? colors : ColorStateList.valueOf(RoundedDrwable.DEFAULT_BORDER_COLOR);
        updateDrawableAttrs();
        updateBackgroundDrawableAttrs(false);
        if (mBorderWidth > 0) {
            invalidate();
